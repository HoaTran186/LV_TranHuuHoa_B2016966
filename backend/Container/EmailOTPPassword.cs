...
{
    public class EmailOTPPassword
    {
        public string GenerateNewPasswordOtpEmailBody(string otp)
        {
            var emailBody = $@"
            <!DOCTYPE html>
            <html lang='vi'>
            ...
            <body>
                <div class='email-container'>
                    ...
                    <div class='email-body'>
                        <h3>Chào bạn,</h3>
                        <p>Bạn đã quên Mật Khẩu Tài Khoản InnoTrade, Mã xác nhận là <span class='otp-code'>{otp}</span>.</p>

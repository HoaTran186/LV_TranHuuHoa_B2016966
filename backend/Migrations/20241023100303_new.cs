        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Forum_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Forum Comment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Forum Comment_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Forum Comment_Forum_ForumId",
                        column: x => x.ForumId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Forum Imgaes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Forum Imgaes_Forum_ForumId",
                        column: x => x.ForumId,
                        principalTable: "Forum",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "81936374-c7bf-4640-8501-92cd93beceea", null, "User", "USER" },
                    { "bbb41d9c-d9dd-4ca8-8675-24f882e3e269", null, "Creator", "CREATOR" },
                    { "c5b5c411-bc40-4260-8a4c-97ac20078fe6", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Forum_AppUserId",
                table: "Forum",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Forum Comment_AppUserId",
                table: "Forum Comment",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Forum Comment_ForumId",
                table: "Forum Comment",
                column: "ForumId");

            migrationBuilder.CreateIndex(
                name: "IX_Forum Imgaes_ForumId",
                table: "Forum Imgaes",
                column: "ForumId");
